create or replace package EXCEL_GENERATOR is

  -- Author  : LEOH
  -- Purpose : Generate MS Excel spreedsheet files (.xlsx).
  -- Created : 18/09/2015 9:34:07 AM
  -- Cloned from web resource: https://technology.amis.nl/2011/02/19/create-an-excel-file-with-plsql/
  ...
  -- input parameters: none, thin, medium, dashed, dotted, thick, double, hair, mediumDashed, dashDot, mediumDashDot, dashDotDot, mediumDashDotDot, slantDashDot
  function get_border
    ( p_top varchar2 := 'thin'
  ...
  function get_alignment
    ( p_vertical varchar2 := null      -- bottom, center, distributed, justify, top
    , p_horizontal varchar2 := null    -- center, centerContinuous, distributed, fill, general, justify, left, right 
...
/
create or replace package body EXCEL_GENERATOR is
--
      ...
      loop
        ...
        loop
          t_cell := '<c r="' || alfan_col( t_col_ind ) || t_row_ind || '"'
                 || ' ' || lc_rows( t_row_ind )( t_col_ind ).style
                 || '><v>'
